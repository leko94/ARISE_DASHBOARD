...
Original file is located at
    https://colab.research.google.com/drive/19QAqjl1hhhGirbch5KAG2MWmFa2Zw3Gd
"""
...
data = pd.read_csv('/content/Nutrint_Pilot.csv')
...
logo2_path = '/content/logo2.png'
logo3_path = '/content/logo3.png'
